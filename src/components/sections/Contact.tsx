          ...
          <div className="flex flex-col items-center text-center w-full mb-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10 w-full max-w-[600px]">
              ...
              >
                ...
                <span className="truncate">{copied ? 'Copied!' : 'e.hossamsabry@gmail.com'}</span>
              </button>
              ...
              >
                ...
                <span className="truncate">0111 866 8625 / 0150 117 1917</span>
              </a>
            </div>

            <div className="flex flex-wrap items-center justify-center gap-4 mt-6">
              <a href="https://www.linkedin.com/in/e-hossamsabry" target="_blank" rel="noopener noreferrer" onClick={() => sendGAEvent('event', 'social_click', { network: 'linkedin' })} className="w-12 h-12 rounded-xl border border-white/10 bg-white/5 flex items-center justify-center hover:bg-[#0A66C2]/10 hover:border-[#0A66C2] transition-all duration-300">
